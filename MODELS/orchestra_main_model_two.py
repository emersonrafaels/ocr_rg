...
from MODELS.main_model_two import main_model as main_model_two_verso
from MODELS.main_model_two_frente import main_model as main_model_two_frente
    ...
    try:
        if tipo_documento == "RG":
            ...
            if verso == True:
                ...
                print("RG - VERSO")
                result_model = main_model_two_verso(imagem)
            elif verso == False:
                # IMAGEM ENVIADA É RG - FRENTE
                print("RG - FRENTE")
                result_model = main_model_two_frente(imagem)
            else:
